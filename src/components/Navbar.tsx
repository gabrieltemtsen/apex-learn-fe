...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Drawer */}
      <div
        className={`fixed top-0 right-0 h-full w-72 bg-slate-900 border-l border-slate-700 z-50 md:hidden transform transition-transform duration-300 ${
        ...
        {isLoaded && isAuthenticated && user && (
          <div className="px-4 py-3 border-b border-slate-700 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs truncate max-w-[170px]">
                {user.primaryEmailAddress?.emailAddress}
              </p>
            </div>
          </div>
