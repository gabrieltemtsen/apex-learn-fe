...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const role = (user?.publicMetadata?.role as string | undefined) ?? "learner";
          ...
          <div className="p-3 border-t border-slate-800">
            <div className="flex items-center gap-3 px-3 py-2 rounded-xl">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-slate-500 text-xs capitalize truncate">{role}</p>
              </div>
              <button
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-xs font-medium ${active ? "text-indigo-400" : "text-slate-600"}`}>
                    {label}
                  </span>
                </Link>
              );
